...
| 端到端 | `scripts/verify-chain.ps1 -UseRunning` | 37 项契约断言（前端容器/认证/分页/隐私/树/审计/时间区间/公告状态机/字段长度上限/IDOR/缺参 400/锁定/数据权限/JWT deptId/密码绑定/停用拒登/脱敏/服务身份越权），见 `docs/guides/run-demo.md` |
